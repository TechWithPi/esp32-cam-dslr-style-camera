/*
  ESP32-S3-CAM (N16R8) - Menu-driven Smart Camera v3
  ...
  - Gallery: delete photo with long-press + confirm screen
  - Nicer UI: header bar, icon cards, footer hints
  ...
  CAPTURE: GPIO1 -> button -> GND (naya, pehle onboard BOOT/GPIO0 tha)
...
void setup() {
  ...
  Serial.println(err == ESP_OK ? "Camera init OK" : "Camera init FAILED");
